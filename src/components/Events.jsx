...
const Events = () => {
  return (
    <div className='mx-3 md:mx-80 font-sourceSans text-[21px] leading-7 py-12'>
        <div className='grid md:flex gap-8'>
            <div className=' w-full md:w-1/2'>
                ...
                <div className='flex py-3 bg-gray-300'>
                    ...
                    <img className='bg-[#004659] w-10 h-10 mt-10' src={rightArrow} alt="right arrow"/>
                </div>
            </div>
            <div className='grid md:flex gap-8 w-full md:w-1/2'>
                ...
                <div className='w-1/2'>
                    ...
                    <div>
                        <div className='grid md:flex gap-3 md:gap-8 py-2'>
                            <p className='text-gray-400  md:w-20 text-sm'>Mar 26 | 2:00 PM</p>
                            <p className='underline text-[16px] '>Service | Introductory Course to Citavi</p>
                        </div>
                        <div className='w-full md:w-72 h-[1px] bg-gray-400'></div>
                        <div className='grid md:flex gap-3 md:gap-8 py-2'>
                            <p className='text-gray-400 w-full md:w-20 text-sm'>Mar 27 | 5:00 PM</p>
                            <p className='underline text-[16px] '>Service | Offene Schreibsprechstunde</p>
                        </div>
                        <div className='w-full md:w-72 h-[1px] bg-gray-400'></div>
                        <div className='grid md:flex gap-3 md:gap-8 py-2'>
                            <p className='text-gray-400 w-full md:w-40 text-sm'>Mar 26 | 2:00 PM</p>
