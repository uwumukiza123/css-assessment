        ...
        <div className='grid md:flex gap-10 md:gap-8'>
            <div className='md:w-2/3'>
                ...
                <div className='flex py-3 bg-gray-300'>
                    <p>Measures Taken against Antisemitism, Racism, and Discrimination: Counseling and Advice Services, Events, University Communication Regarding the Conflict in the Middle East</p>
